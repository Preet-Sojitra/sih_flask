...
with open("naya_model/mbart_model.pkl", "rb") as model_file:
    model = pickle.load(model_file)

with open("naya_model/mbart_tokenizer.pkl", "rb") as tokenizer_file:
...
def translate():
    ...
    print(tgt_languages[target_language])
    ...
    generated_tokens = model.generate(
        **model_inputs, forced_bos_token_id=tokenizer.lang_code_to_id[lang_code]
    )
